...
<head>
    ...
    {{-- ── Primary Meta ───────────────────────────────────────────── --}}
    <title>@yield('title', 'Grand Satya — Corporate Mobility & Travel Management Solutions | Sewa Mobil Corporate Jakarta')</title>
    <meta name="description" content="@yield('meta_description', 'Grand Satya, perusahaan Corporate Transportation & Business Travel Management di Indonesia. Melayani Executive Car Rental, Project Transportation, Professional Driver, dan Corporate Travel Management. Hubungi 0896-3646-3189')">
    ...
    <meta property="og:title"       content="@yield('og_title', 'Grand Satya — Corporate Mobility & Travel Management Solutions')">
    <meta property="og:description" content="@yield('og_description', 'Grand Satya, perusahaan Corporate Transportation & Business Travel Management terpercaya di Indonesia.')">
    <meta property="og:image"       content="@yield('og_image', asset('images/hero/hero2.png'))">
    <meta property="og:image:width"  content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt"    content="Grand Satya Corporate Transportation">

    {{-- ── Twitter / X Card ───────────────────────────────────────── --}}
    <meta name="twitter:card"        content="summary_large_image">
    <meta name="twitter:site"        content="@grandsatya">
    <meta name="twitter:title"       content="@yield('og_title', 'Grand Satya — Corporate Mobility & Travel Management Solutions')">
    <meta name="twitter:description" content="@yield('og_description', 'Grand Satya, perusahaan Corporate Transportation & Business Travel Management terpercaya di Indonesia.')">
...
<body>
    ...
    {{-- WhatsApp Float --}}
    <a href="https://api.whatsapp.com/send?phone=6289636463189&text=Hallo%21%20Saya%20ingin%20melakukan%20pemesanan."
