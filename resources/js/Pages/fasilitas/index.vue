        ...
        <div class="card-body">
            ...
            >
                ...
                <tbody class="fw-bold text-gray-600">
                    <tr v-for="(row, i) in fasilitases.data" :key="row.id">
                        <td>
                            {{ i + 1 }}
                        </td>
                        <td>
                        ...
                        <td class="text-end">
                            ...
                            >
                                <Link
                                    :href="route('fasilitas.show', row.id)"
                                ...
                                <Link
                                    :href="route('fasilitas.edit', row.id)"
                                    type="button"
                                    class="btn btn-icon btn-sm btn-active-light-primary w-30px h-30px me-3"
                                >
                                    <span class="svg-icon svg-icon-3">
    ...
    methods: {
        ...
        _remove(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$inertia.delete(route("fasilitas.destroy", id), {
                        preserveScroll: true,
                        onSuccess: (success) => {
                            // alert('a');
                            console.log(success);
