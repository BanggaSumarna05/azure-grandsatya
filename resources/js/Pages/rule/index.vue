<template>
    <div class="card mb-6 mb-xl-9">
        ...
        <div class="card-body">
            ...
            >
                <thead>
                    <tr>
                        ...
                        <th class="min-w-125px">Peraturan</th>
                        <th class="min-w-50px"></th>
                    </tr>
                </thead>
                <tbody class="fw-bold text-gray-600">
                    <tr v-for="row in rules.data" :key="row.id">
                        <td>
                            {{ row.no }}
                        </td>
                        <td>
            ...
            <div class="modal-footer flex-center" v-if="rules.data.length < 1">
    ...
    methods: {
        ...
        _remove(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.$inertia.delete(route("rule.destroy", id), {
                        preserveScroll: true,
                        onSuccess: (success) => {
                            // alert('a');
                            console.log(success);
